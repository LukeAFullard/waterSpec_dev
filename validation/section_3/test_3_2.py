...
def test_3_2_uniform():
    print("Running 3.2 Uniform...")
    fractions = [0.1, 0.3, 0.5, 0.7, 0.9]
    for beta in BETAS:
        for frac in fractions:
            for seed_idx in range(N_SEEDS):
                seed = get_seed(3, 2000 + int(beta*10) * 100 + int(frac*100) + seed_idx)
                ...
                params = {'beta': beta, 'missing_fraction': frac, 'method': 'uniform'}
                run_test_and_record("3.2_uniform", seed, time, data, time_sub, data_sub, params, beta)
